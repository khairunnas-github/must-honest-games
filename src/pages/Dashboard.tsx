...
import { fetchGames, deleteGame, updateGame, type GameFilters } from "../lib/games";
import type { Game, Status } from "../lib/types";
import { STATUS_LABEL } from "../lib/types";
import GameCard from "../components/GameCard";
import StatsPanel from "../components/StatsPanel";
import AddGameDialog from "../components/AddGameDialog";
import NextUpPicker from "../components/NextUpPicker";
import SessionPanel from "../components/SessionPanel";
import EditGameDialog from "../components/EditGameDialog";
import { exportJson, exportCsv, exportMarkdown } from "../lib/exportImport";
import { Plus, LogOut, Gamepad2, Download } from "lucide-react";
      ...
      <header className="border-b border-border sticky top-0 bg-bg/90 backdrop-blur z-10">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-display font-semibold">Must Honest Game Library</h1>
          </div>
          <div className="flex items-center gap-2">
